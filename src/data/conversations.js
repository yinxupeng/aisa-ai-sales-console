...
const rawConversations = [
  {
    ...
    lifecycle: customerServiceStages[2],
    lifecycleStage: 2,
  ...
  },
  {
    ...
    intent: "高",
    status: "待确认发送",
    last: "行吧李老师，那你发我付款二维码，我先定下来！",
    phone: "138****7788",
    wecomId: "wm_cust_1024",
    lifecycle: customerServiceStages[1],
    ...
    hosted: true,
    lifecycleStage: 1,
    remark: "张妈妈-初二词汇薄弱·已成单",
    consultant: "李销售",
    addedAt: "2026-05-27 14:56",
    crmSource: "SCRM同步",
    suggestion: "张妈妈已确定报名意向，建议发送付款二维码并说明前两周不满意随时退的保障，完成闭环收款。",
    reason: "家长明确提出三步拆解建议并索要付款码，准备完成锁位支付。",
    messages: [
      { from: "system", text: "你已添加了张妈妈，现在可以开始聊天了。", time: "09:58" },
      { from: "customer", text: "孩子初二，英语一直不太敢开口，单词记得慢。", time: "10:02" },
      { from: "ai", text: "初二这个阶段很关键。现在的家庭开销确实很大，每一分钱花在孩子身上都要看到实在的效果。❤️", time: "10:03" },
      { from: "customer", text: "正价课将近四千太贵了，家庭开销压力挺大，还是算了吧。", time: "10:20" },
      {
        from: "ai",
        text: "张妈妈太理解您了！不过咱们算一笔账：整个90天系统辅导平均到每天大概就40多块钱，少下一次馆子，却能帮小明在初二关键期把抗拒学习的坏习惯改过来。要是到了初三再找机构一对一单科补习，动辄几千上万还治标不治本。",
        time: "10:21"
      },
      { from: "customer", text: "也是这么个道理…那你们能保证有效果吗？", time: "10:23" },
      { from: "ai", text: "小明这次4节体验课全勤，老师专门向主管申请了咱们这期仅剩2个的‘成长激励名额’，还有前两周不满意随时退的保障。今晚我先帮小明把这个名额锁住，您看可以吗？", time: "10:24" },
      { from: "customer", text: "行吧李老师，那你发我付款二维码，我先定下来！", time: "10:25" }
    ],
    orders: [
      { id: "C-20260612-01", product: "初二英语90天成长营", amount: "¥3,980", status: "已成单付款", paidAt: "2026-06-12 10:28" }
    ]
  },
  {
    key: "c2",
    ...
    intent: "低",
    status: "已流失",
    last: "（已读未回，后续24小时发3条催促消息均无响应）",
    phone: "139****6621",
    wecomId: "wm_cust_2031",
    lifecycle: customerServiceStages[0],
    tags: ["体验课后嫌贵", "直接甩券后断联", "流失预警"],
    order: "体验课后流失",
    matchedSkills: ["19元A类课-课前", "19元A类课-第一课"],
    sendMode: "自动发送",
    hosted: false,
    lifecycleStage: 0,
    remark: "刘女士-初一·硬推券后流失",
    consultant: "陈销售",
    addedAt: "2026-06-02 11:12",
    crmSource: "SCRM同步",
    suggestion: "老策略机械甩券已引发抵触，建议暂停机械促单，转由真人主管在48小时后以课后学情报告形式低频破冰。",
    reason: "客户连续多条消息已读不回，进入掉单冷冻状态。",
    messages: [
      { from: "customer", text: "孩子刚上初一，体验课听完了，正价课将近四千太贵了，我们再考虑考虑吧。", time: "14:10" },
      {
        from: "ai",
        text: "刘女士，我们原价是3980元的，包含名师1对1定制。现在体验课学员立减500元，只要3480元！优惠券链接：https://sabuddy.com/coupon/500，今天24点前有效，您赶紧领了付款吧。",
        time: "14:12"
      },
      { from: "customer", text: "（已读未回，后续24小时发3条催促消息均无响应）", time: "14:15" }
    ],
    orders: [
      { id: "NO-ORDER-C2", product: "初一英语正价课", amount: "¥3,980", status: "已流失未付款", paidAt: "-" }
    ]
  },
  {
    key: "c3",
    ...
    lifecycle: customerServiceStages[3],
    tags: ["夫妻商量延宕", "被动等待失联", "流失客户"],
    order: "被动等待商量后流失",
    matchedSkills: ["19元A类课-课前", "通知真人销售"],
    sendMode: "自动发送",
    hosted: false,
    lifecycleStage: 3,
    remark: "陈妈妈-初一·被动等待后流失",
    consultant: "陈销售",
    addedAt: "2026-06-01 16:42",
    crmSource: "SCRM同步",
    suggestion: "老策略被动等待已致断联，后续需由新策略‘提供转述要点+时间锚点’代替被动应答。",
    reason: "客户表达商量后AI未锁住跟进锚点，线索冷凝。",
    messages: [
      { from: "customer", text: "试听课孩子说还挺喜欢的，但正价课我要跟孩子爸爸商量商量。", time: "10:15" },
      {
        from: "ai",
        text: "好的陈妈妈，那您跟爸爸商量好了随时叫我哈，我们都在的。",
        time: "10:16"
      },
      { from: "customer", text: "（无后续消息，断联已超72小时）", time: "10:18" }
    ],
    orders: [
      { id: "O-20260610-18", product: "五年级英语寒假冲刺班", amount: "¥5,680", status: "已流失", paidAt: "-" }
    ]
  },
  {
    key: "c4",
  ...
  },
  {
    ...
    intent: "高",
    status: "AI接待中",
    last: "太棒了！已为您锁定周六班名额，欢迎周妈妈和小明加入成长营！",
    phone: "152****8619",
    wecomId: "wm_li_demo_006",
    lifecycle: customerServiceStages[3],
    lifecycleStage: 3,
    tags: ["肯定父母共同决策", "提供转述三要点", "高意向", "已成单"],
    order: "正价自然拼读班已成单",
    matchedSkills: ["19元A类课-第一课", "19元A类课-课后"],
    sendMode: "自动发送",
    hosted: true,
    remark: "周女士-初二·转述三要点成单",
    consultant: "李销售",
    addedAt: "2026-06-13 11:05",
    suggestion: "客户已完成定金锁定与全款支付，后续按交付计划发送课前包与开学安排。",
    reason: "客户要求报名链接，AI主动促成夫妻共识后顺利收单。",
    messages: [
      { from: "customer", text: "李老师，课程很认可，但我得晚上跟孩子爸爸商量一下再决定。", time: "11:00" },
      {
        from: "ai",
        text: "特别支持您周女士！孩子的教育大事确实需要爸爸妈妈达成共识。👨‍👩‍👦 爸爸平时工作忙没听体验课，您跟他沟通时抓这3点就行：1.小明在课上第一次主动发言了；2.每天只花20分钟不占用周末刷题时间；3.前两周有不满意无条件退费兜底。今晚9点半等爸爸忙完，我再给您发一份专门评语带给爸爸看！",
        time: "11:01"
      },
      { from: "customer", text: "太感谢李老师了，你替我想得太周到了，我晚上就这么跟他说！", time: "11:03" },
      { from: "customer", text: "李老师在吗？晚上跟爸爸商量好了，报名链接发我吧，先占周六班！", time: "21:32" },
      { from: "ai", text: "太棒了！已为您锁定周六班名额，欢迎周妈妈和小明加入成长营！", time: "21:33" }
    ],
    orders: [
      { id: "O-LI-006", product: "三年级周六自然拼读班", amount: "¥3,980", status: "已成单付款", paidAt: "2026-06-13 21:35" }
    ]
  },
  {
    key: "li-demo-7",
  ...
  },
  {
    ...
    lifecycle: customerServiceStages[4],
    lifecycleStage: 4,
...
const youthConversationOverrides = {
  ...
  c3: {
    ...
    reason: "家长询问名额和报名，已进入A类第三节课后的转化跟进，涉及付款和服务承诺，建议人工确认后发送。",
    messages: [
...
export const lifecycleStages = [
  { title: customerServiceStages[0], desc: "加好友后完成课前预热、资料收集和上课提醒。", skills: ["19元A类课-课前"] },
  { title: customerServiceStages[1], desc: "围绕第一节课做提醒、课堂反馈和继续学习引导。", skills: ["19元A类课-第一课"] },
  { title: customerServiceStages[2], desc: "跟进第二节课出勤、学习反馈和家长疑问。", skills: ["19元A类课-第二课"] },
  { title: customerServiceStages[3], desc: "跟进第三节课后的关键反馈和转化沟通。", skills: ["19元A类课-第三课"] },
  { title: customerServiceStages[4], desc: "跟进第四节课后的效果确认、顾虑处理和报名推进。", skills: ["19元A类课-第四课"] },
  { title: customerServiceStages[5], desc: "跟进第五节课后的阶段总结、方案确认和成交动作。", skills: ["19元A类课-第五课"] },
  { title: customerServiceStages[6], desc: "课程结束后做复盘、续报承接和长期服务转化。", skills: ["19元A类课-课后"] }
];
